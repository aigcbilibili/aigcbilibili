...
public class CollectController {
    ...
    @PostMapping("/collect")
    @ApiOperation("收藏视频")
    public Result<Boolean> collect(@RequestBody CollectRequest collectRequest) {
        log.info("收藏视频");
    ...
    @GetMapping("/getCollectVideo/{userId}")
    @ApiOperation("获取首页收藏夹视频")
    public Result<List<CollectVideoResponse>> getCollectVideo(@PathVariable Integer userId) {
        return collectService.getCollectVideo(userId);
    }
}
