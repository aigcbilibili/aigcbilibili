...
public class GetNoticeServiceImpl implements GetNoticeService {
    ...
    public Result<List<DynamicVideoResponse>> getDynamicVideo(Integer userId) {
        ...
        wrapper.innerJoin(User.class, User::getId, Dynamic::getAuthorId);
        ...
        List<DynamicVideoResponse> list=dynamicToUserMapper.selectJoinList(DynamicVideoResponse.class,wrapper);
