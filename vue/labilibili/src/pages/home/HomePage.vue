    ...
    <div class="header flex-between-container" @click="scollToTop()"><!--NOTE vue3不支持@on-click绑定-->
      ...
      <div class="left-align">
        ...
        <div class="title-link">
          <span v-for="(item, index) in titleFunc" :key="index" style="cursor: pointer;" @click.stop="handleNewPage(index)">
            <span style="margin-right: 2rem; color: #fff; font-weight: 600;font-size:1.2rem; overflow: hidden;">{{item}}</span>
          </span>
        </div>
      </div>
       <!--|最右边|-->
      ...
      <div class="person-center">
        ...
        <el-dropdown class="person-dropdown" id="person-dropdown" @command="handleCommand">
          <img class="person-avater common-avatar" id="person-dropdown-trigger"
          :src="userAvatar" />
          <template #dropdown>
