...
public class FollowController {
    ...
    @ApiOperation("查看关注或粉丝列表")
    @PostMapping("/getIdolOrFansList/{userId}/{type}")
    public Result<List<IdolOrFansListResponse>> getIdolOrFansList(@PathVariable Integer userId, @PathVariable Integer type){
        log.info("1");
        return followService.getIdolOrFansListResponse(userId,type);
    }
